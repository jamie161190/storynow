// EXPERIMENTAL middle-layer prompt — DO NOT USE IN PRODUCTION.
// This is the Tier 2 A/B variant of netlify/functions/lib/middle-layer-prompt.mjs.
// For this round, the middle layer is IDENTICAL to production. Tier 2 changes
// are writer-prompt only. This file exists so the A/B runner has a parallel
// import path; if Tier 2 ever extends to middle-layer changes, edit here.
...
- **A recognition** — the child hears something so specifically about them they go still ("the small thing only Oliver would have noticed", "the way Mira always says 'oopsie'")
...
Write the key moment as ONE SENTENCE in the voice of the story. It is the writer's target, not a literal line for the story. Examples:
...
- "Nobody said anything for a long moment, and that was the most they had ever said."

Without a key moment named, the writer constructs a competent shape and lands the moment by accident, when the personal details collide with halfway-decent prose. With one named, every other beat in the story is ordered toward it.
...

{
  ...
  "key_moment": "One sentence in the voice of the story. The single emotional beat the story is reaching for: a recognition, an arrival, or a quiet. The writer's target, not a literal line for the story. e.g. 'And there, where Oliver had pointed, was the smallest blue feather in the world.'",
