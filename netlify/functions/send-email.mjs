  ...
  <div style="max-width:520px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:32px 24px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
      ...
      <div style="background:#E3FAEB;border-radius:12px;padding:16px;margin:0 0 20px;text-align:center;">
        ...
        <p style="margin:0 0 8px;font-size:13px;color:#666;line-height:1.5;">Because you are part of the Hear Their Name family. Use code <strong style="color:#6B2F93">${esc(discountCode)}</strong> at checkout.</p>
...
function giftEmail(childName, giftFrom, giftMessage, storyId) {
  ...
  const listenUrl = storyId ? `https://heartheirname.com?listen=${encodeURIComponent(storyId)}` : 'https://heartheirname.com';
  return `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
  ...
  <div style="max-width:520px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:32px 24px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
      ...
      <p style="color:#999;font-size:13px;text-align:center;line-height:1.5;margin:0;">
        This story was made with love using Hear Their Name, where every child becomes the hero of their own audio adventure.
      </p>
    </div>
    <p style="text-align:center;color:#bbb;font-size:12px;margin-top:24px;">Hear Their Name. Audio stories that know them by name.</p>
  </div>
  ...
  <div style="max-width:520px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:32px 24px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
      ...
      <div style="text-align:center;">
        <a href="https://heartheirname.com" style="color:#6B2F93;font-size:14px;font-weight:600;text-decoration:none;">Create your own story &rarr;</a>
      </div>
    </div>
    <p style="text-align:center;color:#bbb;font-size:12px;margin-top:24px;">Hear Their Name. Audio stories that know them by name.</p>
  </div>
