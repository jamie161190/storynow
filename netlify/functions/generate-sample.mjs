...
export default async (req) => {
  ...
  const storyText = `This story was made just for you, Chase. So snuggle up, get cosy, and let's begin.

Once upon a time, in a cosy little house at the end of Maple Lane, there lived a boy called Chase. Chase loved two things more than anything in the whole wide world: adventures, and his best friend Woody.
